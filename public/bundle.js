...
var _convertToSimpleArray = __webpack_require__(60);

var _convertToSimpleArray2 = _interopRequireDefault(_convertToSimpleArray);
...
var App = function () {
    function App(server) {
        ...
        this.socket = (0, _socket2.default)(server);
        this.rootNode = document.querySelector('#root');
        this.table = new _Table2.default(null);

        fetch('/data').then(function (response) {
            return response.json();
        }).then(function (response) {
            _this.table.setState((0, _convertToSimpleArray2.default)(response.data));
            _this.rootNode.innerHTML = _this.render();
        });
    }
    ...
    _createClass(App, [{
        ...
        value: function init() {
            ...
            this.socket.on('data', function (response) {
                _this2.table.setState((0, _convertToSimpleArray2.default)(response.data));
                _this2.rootNode.innerHTML = _this2.render();
            });
        }
    }, {
        key: 'render',
...
var Table = function () {
    ...
    _createClass(Table, [{
        ...
        value: function renderOptions() {
            ...
            return this.state.reduce(function (html, cell, index) {
                var cssClass = '';

                if (_this.prevState != null) {
                    if (cell < _this.prevState[index]) {
                        cssClass = 'cell_down';
                    } else if (cell > _this.prevState[index]) {
                        cssClass = 'cell_up';
                    }
                }
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./Table.styl", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./Table.styl");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var app = new _App2.default('http://localhost:1213');
app.init();
